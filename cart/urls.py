...
urlpatterns = [
    ...
    path('coupon/',
         views.CouponApply.as_view(), name='add-coupon'),
    path('coupon_validate/',
         views.CouponValidate.as_view(), name='validate-coupon'),
    path('coupon_remove/<pk>/',
         views.CouponRemove.as_view(), name='remove-coupon'),
